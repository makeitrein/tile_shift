...
export const TooltipMenu = ({ moveable }) => {
  ...
  return (
    <div className="absolute top-0 w-full -mt-12	z-1000 left-0 flex items-center justify-center cursor-pointer">
      ...
      <div className="-ml-px relative inline-block text-left">
        <Menu>
          {({ open }) => (
            <>
              <span className="rounded-md shadow-sm">
                <Menu.Button className="inline-flex justify-center w-full px-4 py-1 text-sm font-medium text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-r-md hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800">
                  <span>Normal</span>
                  <svg
              ...
              >
                <Menu.Items
                  static
                  className="absolute z-1000 right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                >
                  <div className="py-1">
                    <Menu.Item>
                      {({ active }) => (
                        <a
                          ...
                          className={`${
                            active
                              ...
                              : "text-gray-700"
                          } flex justify-between w-full px-4 py-2 text-xs text-left`}
                        >
                          Small
                        </a>
                      )}
                        ...
                        <a
                          ...
                          className={`${
                            active
                              ? "bg-gray-100 text-gray-900"
                              : "text-gray-700"
                          } flex justify-between w-full px-4 py-2 text-2xl text-left`}
                        >
                          Large
                        </a>
                      )}
                        ...
                        <a
                          ...
                          className={`${
                            active
                              ? "bg-gray-100 text-gray-900"
                              : "text-gray-700"
                          } flex justify-between w-full px-4 py-2 text-4xl text-left`}
                        >
                          Huge
                        </a>
                      )}
